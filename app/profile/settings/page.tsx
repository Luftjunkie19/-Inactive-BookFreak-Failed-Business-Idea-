      ...
      <div className="sm:h-[calc(100vh-3rem)] xl:h-[calc(100vh-3.5rem)] overflow-y-auto w-full">
        {document && document.data &&<div className='flex flex-col gap-12'>
          ...
          <div className="flex gap-8 items-center absolute -bottom-12 left-4 m-2">
            <Image src={document.data.photoURL} alt='' width={60} height={60} className='lg:w-48 lg:h-48 sm:w-28 sm:h-28 rounded-full' />
            </div>
          ...
          <div className="flex sm:flex-col lg:flex-row gap-4  lg:items-center w-full">
            <LabeledInput containerStyle='max-w-xs w-full' additionalClasses='p-2 max-w-xs w-full' type='dark' label="Nickname" />
            <LabeledInput containerStyle='max-w-xs w-full' additionalClasses='p-2 max-w-xs w-full' type='dark' label="Email" />
