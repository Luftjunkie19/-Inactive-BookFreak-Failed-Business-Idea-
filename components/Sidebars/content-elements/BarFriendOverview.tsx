...
function BarFriendOverview({username, image, userId}: Props) {
  return (
    <Link href={`/profile/${userId}`} className="flex group gap-3 items-center hover:bg-white/80 transition-all duration-500  cursor-pointer px-2 py-1 rounded-lg w-full">
