...
function RankingListItem({image, username, booksAmount, pagesAmount,rankingPlace}: Props) {
  return (
    ...
    <div className="flex flex-col flex-1 gap-1">
      <p>{username}</p>
      <p className='text-sm font-light'>{booksAmount ? `${booksAmount} Books` : `${pagesAmount} Pages`}</p>
    </div>
