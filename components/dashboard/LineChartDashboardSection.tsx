...
import { ShadcnLineChart, ShadcnPieChart, ShadcnRadialChart } from 'components/charts/ShadcnChart';
...
function LineChartDashboardSection({document}: Props) {
  ...
  return (
    ...
    <p className='text-white text-2xl'>Your Reading Progress Overview</p>
...
export default LineChartDashboardSection