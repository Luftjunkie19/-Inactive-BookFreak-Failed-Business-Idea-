...
<FaLock className='group-hover:text-primary-color transition-all text-lg' />
   ...
   <div className="sm:h-[calc(100vh-3rem)] xl:h-[calc(100vh-3.5rem)]  px-3 py-2 overflow-y-auto w-full">
            <div className="mx-auto w-full my-6 max-w-2xl flex flex-col gap-2  bg-dark-gray rounded-lg p-2">
        ...
        <div className="flex flex-col w-full max-h-80 overflow-y-auto gap-2">
        <div className="flex items-center max-w-xl w-full gap-3 justify-between bg-secondary-color rounded-lg px-2 py-3">
  ...
  <VisibilityPopover propertyName={'currentBook'} />
      ...
      <Button onClick={mutateAsync} type='blue' additionalClasses='px-6 mt-4 w-fit self-end'>Update</Button>
    </div>
      </div>
  )
}
